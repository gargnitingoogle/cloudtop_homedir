# $Id: //depot/google3/googledata/corp/puppet/goobuntu/common/modules/shell/files/bash/skel.bashrc#11 $
...
# The following doesn't work, probably because as the following folder doesn't 
# mount at the initialization of bash, it is mounted by the gcert
# command
# cd /google/src/cloud/$USER

export PKG_CONFIG_PATH=~/opencv_build/opencv/build/unix-install:$PKG_CONFIG_PATH

# For using bcompare for piper
#Perforce
...
gcertstatus -check_remaining=1h -nocheck_ssh -quiet
if [ $? -ne 0 ]; then
    echo "Renewing prod access. Running gcert."
    gcert
fi
